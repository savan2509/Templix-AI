...
export const FIELD_DEFAULTS: Record<string, string> = {
  ...
  warrantyTerms: "1-year standard warranty on parts and workmanship included.",
...
export const SLUG_SPECIFIC_DEFAULTS: Record<string, Record<string, string>> = {
  "quotation-solar-panel-installation": {
    quoteNumber: "QT-SOLAR-2026-084",
    quoteDate: "July 12, 2026",
    validUntil: "August 12, 2026",
    installerName: "SunPeak Renewable Energy Inc.",
    ...
    federalTaxCredit: "$6,480.00 (30% Federal ITC)",
    subtotal: "$21,600.00",
    taxAmount: "$0.00 (Solar Tax Exempt)",
    netCost: "$15,120.00",
    warrantyTerms: "25-Year Manufacturer Equipment & 10-Year Workmanship Warranty",
  },
  "quotation-catering-event-menu": {
    quoteNumber: "QT-CAT-2026-319",
    quoteDate: "July 15, 2026",
    ...
    clientName: "Apex Global Technology",
    guestCount: "120",
    menuTier: "Platinum 3-Course Banquet",
    perPlateRate: "$85.00 / plate",
    barServiceFee: "$1,850.00",
    subtotal: "$10,200.00",
    serviceGratuity: "$1,836.00 (18%)",
    total: "$13,886.00",
    depositTerms: "50% deposit upon confirmation; balance due 7 days prior to event.",
  },
  "quotation-it-services-msp": {
    quoteNumber: "QT-MSP-2026-441",
    quoteDate: "July 10, 2026",
    validUntil: "August 10, 2026",
    mspName: "Apex Cloud & Managed IT Solutions",
    mspAddress: "100 Innovation Way, Suite 800, Austin, TX 78701",
    clientName: "Vanguard Legal Partners LLC",
    serverCount: "18 virtual servers / 65 workstations",
    monthlyRetainer: "$3,450.00 / month",
    subtotal: "$3,450.00",
    total: "$3,450.00",
    onboardingFee: "$1,200.00 one-time",
  },
  "business-plan-fashion-brand": {
    companyName: "Aethel Luxury Studio",
    ownerName: "Sophia Rossi",
    founderName: "Sophia Rossi",
    grossMargins: "68% – 72%",
    profitMargin: "26.4% EBITDA",
    revenueModel: "Direct-to-Consumer e-Commerce & Select Boutique Wholesale",
    fundingRequired: "$850,000 Seed Round",
    tam: "$48 Billion Global Sustainable Apparel Market",
  },
  "business-plan-sustainable-fashion-brand": {
    companyName: "Aethel Luxury Studio",
    ownerName: "Sophia Rossi",
    founderName: "Sophia Rossi",
    grossMargins: "68% – 72%",
  ...
  "business-plan-coffee-roastery": {
    companyName: "Highland Artisan Roasters",
    ownerName: "Liam O'Connor",
    founderName: "Liam O'Connor",
    grossMargins: "62% – 66%",
    revenueModel: "Specialty Cafe Retail, Direct Subscriptions & Wholesale Accounts",
    fundingRequired: "$450,000 Buildout & Equipment Capital",
  },
  "business-plan-specialty-coffee-roastery": {
    companyName: "Highland Artisan Roasters",
    ownerName: "Liam O'Connor",
    founderName: "Liam O'Connor",
    grossMargins: "62% – 66%",
  ...
  "business-plan-fitness-studio": {
    companyName: "Pulse Performance Fitness",
    ownerName: "Maya Lin",
    founderName: "Maya Lin",
    equipmentAndFitOut: "$95,000 commercial strength, HIIT & cardio installation",
    revenueModel: "Recurring Monthly Memberships ($149/mo) & Personal Coaching Tiers",
    grossMargins: "74%",
    fundingRequired: "$350,000 Studio Fit-Out & Working Capital",
  },
  "business-plan-boutique-fitness-studio": {
    companyName: "Pulse Performance Fitness",
    ownerName: "Maya Lin",
    founderName: "Maya Lin",
    equipmentAndFitOut: "$95,000 commercial strength, HIIT & cardio installation",
  ...
  "business-plan-ai-saas": {
    companyName: "Synthex AI Platform",
    ownerName: "Marcus Chen",
    founderName: "Marcus Chen",
    tam: "$18.5 Billion Total Addressable Market (TAM)",
    sam: "$4.2 Billion Serviceable Available Market",
    year3TargetArr: "$5.4M ARR",
    targetArr: "$4.8M ARR",
    grossMargins: "82% SaaS Gross Margin",
    revenueModel: "Tiered SaaS Subscriptions ($49–$299/mo) & Enterprise Custom API Licenses",
    capital: "$1,500,000 Seed Capital",
  },
  "business-plan-ai-saas-startup": {
    companyName: "Synthex AI Platform",
    ownerName: "Marcus Chen",
    founderName: "Marcus Chen",
    tam: "$18.5 Billion Total Addressable Market (TAM)",
  ...
  "business-plan-telehealth-platform": {
    companyName: "CarePulse Telehealth Inc.",
    ownerName: "Dr. Amanda Rivera",
    founderName: "Dr. Amanda Rivera",
    revenueModel: "Patient Consultations ($75/visit), Specialist Tiers & Provider SaaS Licensing",
    capital: "$1,200,000 Seed Venture Capital",
    grossMargins: "71%",
    tam: "$28.4 Billion Digital Healthcare Market",
  },
  "business-plan-digital-health-clinic": {
    companyName: "CarePulse Telehealth Inc.",
    ownerName: "Dr. Amanda Rivera",
    founderName: "Dr. Amanda Rivera",
    revenueModel: "Patient Consultations ($75/visit), Specialist Tiers & Provider SaaS Licensing",
  ...
  "report-inventory-warehouse-audit": {
    reportTitle: "Annual Warehouse Inventory & Stock Accuracy Audit",
    discrepancyRate: "0.38% SKU variance",
    deadStockValue: "$18,400 obsolete inventory",
    accuracyRate: "99.62% Net Inventory Accuracy",
    preparedBy: "Rachel Adams, Director of Supply Chain Operations",
  },
  "report-employee-training-evaluation": {
    reportTitle: "Quarterly Learning & Professional Development Impact Report",
    completionRate: "94.6% course completion",
    cohortSize: "64 participants across 4 cohorts",
    npsScore: "+68 Participant NPS",
    preparedBy: "David Sterling, Head of Talent Development",
  },
  "report-warehouse-inventory-audit": {
    reportTitle: "Annual Warehouse Inventory & Stock Accuracy Audit",
    discrepancyRate: "0.38% SKU variance",
    deadStockValue: "$18,400 obsolete inventory",
    accuracyRate: "99.62% Net Inventory Accuracy",
  ...
  "report-learning-development-metrics": {
    reportTitle: "Quarterly Learning & Professional Development Impact Report",
    completionRate: "94.6% course completion",
    cohortSize: "64 participants across 4 cohorts",
    npsScore: "+68 Participant NPS",
  ...
  "resume-healthcare-ats": {
    fullName: "Sarah Alpert, BSN, RN",
    clinicalTitle: "Registered Nurse (ICU & Critical Care)",
    licenseNumber: "RN-CA-948120 (Compact Multi-State Active)",
    email: "sarah.alpert.rn@medmail.com",
    phone: "+1 (415) 555-0182",
    location: "San Francisco, CA",
    clinicalSummary: "Compassionate, board-certified Critical Care Registered Nurse (CCRN) with 6+ years in level 1 trauma center ICU. Proven track record managing 1:1 and 1:2 patient acuity, mechanical ventilation, hemodynamic monitoring, and rapid code responses.",
    ehrSoftwareSkills: "Epic Systems (Certified Super-User), Cerner Millennium, Meditech, Pyxis MedStation, Alaris IV Infusion Systems",
    hospitalExperience: "Lead Critical Care RN — UCSF Medical Center (2021–Present)\n• Administered advanced pharmacological protocols including titration of vasoactive drips and ECMO monitoring.\n• Precepted and mentored 14 new-graduate ICU nurses and float pool staff on infection control protocols.",
    patientCareMetrics: "Maintained 0% CLABSI/CAUTI rate across 180 consecutive shifts; achieved 98% patient satisfaction score.",
    nursingDegree: "Bachelor of Science in Nursing (BSN) — University of California, San Francisco",
    certificationsList: "CCRN (AACN #48192), ACLS, BLS (AHA), PALS, NIHSS Stroke Certification"
  },
  "resume-finance-ats": {
    fullName: "David K. Harrison, CFA",
    financeTitle: "Senior Financial Analyst (FP&A & Corporate Valuation)",
    email: "d.harrison@finanalytics.com",
    phone: "+1 (212) 555-0149",
    location: "New York, NY",
    linkedin: "linkedin.com/in/david-harrison-cfa",
    summaryText: "CFA charterholder and quantitative financial analyst with 7+ years of expertise in corporate FP&A, 3-statement financial modeling, DCF valuations, and SaaS unit economics ($45M+ ARR oversight).",
    financialModelingSkills: "Advanced Financial Modeling (DCF, LBO, M&A), Python (Pandas/NumPy), SQL, Power BI, Bloomberg Terminal, NetSuite, Hyperion",
    roleTitle1: "Lead FP&A Analyst",
    company1: "Meridian Capital Partners",
    dates1: "2021 – Present",
    bullet1a: "Engineered rolling 5-year forecast models across 6 business divisions, improving budget accuracy by 18% over prior fiscal years.",
    bullet1b: "Conducted comprehensive DCF and sensitivity analyses for $85M strategic acquisition that closed ahead of Q3 schedule.",
    educationDegree: "B.S. in Finance & Econometrics, New York University (Stern School of Business)",
    cpaOrCfaDetails: "CFA Charterholder (#91823), FMVA Certified (Corporate Finance Institute)"
  },
  "resume-marketing-ats": {
    fullName: "Elena Rostova",
    marketingTitle: "Growth Marketing & SEO Director",
    email: "elena.rostova@growthlead.com",
    phone: "+1 (312) 555-0177",
    location: "Chicago, IL",
    linkedin: "linkedin.com/in/elena-rostova-growth",
    portfolio: "elenarostova.co",
    summaryText: "Data-driven Growth Marketing Leader with 8+ years scaling B2B SaaS ARR from $2M to $25M through organic search, paid acquisition funnels, CRO testing, and automated lifecycle marketing.",
    marketingTechStack: "Google Ads, Meta Ads Manager, GA4, Semrush, Ahrefs, HubSpot Enterprise, Webflow, Segment, Looker Studio",
    experienceCompany: "CloudScale Technologies",
    experienceRole: "Senior Director of Performance & Growth",
    experienceDates: "2021 – Present",
    growthMetricsBullet1: "Scaled organic search revenue +142% YoY by executing a 250-cluster topical authority roadmap.",
    growthMetricsBullet2: "Reduced Customer Acquisition Cost (CAC) by 28% while increasing MQL-to-SQL conversion from 11% to 19.4%.",
    educationDegree: "B.A. in Marketing & Data Analytics, Northwestern University"
  },
  "simple-nda-agreement": {
    partyAName: "Alex Mercer",
    partyACompany: "Nexis Innovations Inc.",
    partyBName: "Jordan Taylor",
    partyBCompany: "Apex Solutions LLC",
    purposeOfDisclosure: "evaluating a potential strategic joint venture, software API integration, and commercial partnership",
    termYears: "3",
    governingState: "the State of Delaware",
    effectiveDate: "July 15, 2026",
    partyASignature: "Alex Mercer, CEO",
    partyBSignature: "Jordan Taylor, Managing Director"
  },
  "seo-service-contract": {
    agencyName: "SearchPeak Digital Media",
    agencyAddress: "750 Lexington Ave, New York, NY 10022",
    clientName: "David Vance",
    clientCompanyName: "Horizon Logistics Corp.",
    monthlyRetainer: "$3,500.00 / month",
    scopeDeliverables: "Comprehensive technical SEO audits, Core Web Vitals optimization, 8 monthly targeted cluster articles, backlink acquisition, and keyword position tracking",
    reportingCadence: "Bi-weekly executive dashboard and monthly strategy review",
    minimumTermMonths: "6",
    startDate: "August 1, 2026",
    agencySignature: "Marcus Vance, Managing Partner",
    clientSignature: "David Vance, VP of Growth"
  },
  "web-design-contract": {
    designerName: "Sarah Jenkins",
    designerBusiness: "PixelCraft Interactive LLC",
    clientName: "Michael Chang",
    clientCompany: "Beacon Financial Advisors",
    totalProjectFee: "$8,500.00",
    depositAmount: "$4,250.00 (50% upfront deposit)",
    milestoneSchedule: "Phase 1: Wireframes & UX (2 wks), Phase 2: High-fidelity Figma design (2 wks), Phase 3: Next.js frontend development & CMS integration (3 wks)",
    revisionRounds: "3 rounds of revisions per milestone",
    ipTransferTerms: "Full intellectual property and source code ownership transfer upon final payment settlement.",
    designerSignature: "Sarah Jenkins, Creative Director",
    clientSignature: "Michael Chang, CEO"
  },
  "seo-proposal": {
    agencyName: "SearchPeak Digital Media",
    clientName: "Apex Health Innovations",
    clientWebsite: "www.apexhealthinnovations.com",
    executiveSummary: "A strategic roadmap to capture top-3 organic Google rankings for 65+ high-intent telehealth and medical device search terms, estimated to generate 35,000 monthly qualified organic visitors within 6 months.",
    technicalAuditFindings: "Identified crawl budget bottlenecks, missing schema.org metadata on 40 product pages, and 1.8s LCP delays.",
    targetKeywords: "telehealth medical software, remote patient monitoring platform, HIPAA compliant clinical tools",
    monthlyFee: "$4,200.00 / month",
    projectedGrowth: "+210% increase in organic leads and 3.4x return on marketing investment",
    agencyRepresentative: "Marcus Vance, Head of Search Strategy"
  },
  "web-design-proposal": {
    studioName: "PixelCraft Interactive LLC",
    clientName: "Aurora Renewable Energy",
    projectObjective: "Design and launch a modern, high-converting digital storefront and interactive product configurator for commercial solar systems.",
    uiUxApproach: "Clean minimalist aesthetic, accessible WCAG 2.1 AA typography, mobile-first layouts, and interactive 3D component renders.",
    technicalStack: "Next.js 16, Tailwind CSS, TypeScript, Supabase backend, and Stripe checkout integration.",
    sprintTimeline: "8 weeks across 4 iterative 2-week agile sprints",
    totalInvestment: "$12,500.00",
    studioLead: "Sarah Jenkins, Principal Design Director"
  },
  "sponsorship-proposal": {
    eventName: "Global Tech Innovations Summit 2026",
    eventDate: "November 12–14, 2026",
    eventLocation: "Moscone Center, San Francisco, CA",
    organizerName: "FutureTech Media Foundation",
    audienceDemographics: "3,500+ attendees: 42% C-level Executives & Founders, 35% VP of Engineering & Product, 23% Tech Investors",
    tierGoldFee: "$25,000.00",
    tierGoldBenefits: "Keynote session opening remarks, prime 20x20 exhibition booth, logo on all main stage livestreams, and 10 VIP passes.",
    tierSilverFee: "$12,500.00",
    tierSilverBenefits: "Dedicated workshop track sponsorship, 10x10 exhibition space, branded coffee station, and 5 VIP passes.",
    sponsorContact: "sponsors@globaltechsummit.org | +1 (415) 555-0198"
  },
  "construction-bid-proposal": {
    contractorName: "Highland Contracting Group",
    licenseNumber: "CSLB Lic. #892014 (Class B General Building)",
    clientName: "Oakridge Commercial Properties",
    projectSiteAddress: "450 Industrial Parkway, Suite 200, San Jose, CA",
    scopeOfWork: "Complete commercial tenant improvement: demolition of existing partitions, structural steel framing, electrical upgrades (400A panel), HVAC distribution ducting, drywall finishing, and acoustic ceiling installation per architectural plans A-101 through A-108.",
    materialsCost: "$48,500.00",
    laborCost: "$36,200.00",
    permitsCost: "$4,800.00",
    totalBidAmount: "$89,500.00",
    estimatedDuration: "10 weeks from permit issuance",
    warrantyTerms: "1-year comprehensive contractor craftsmanship warranty plus full manufacturer product warranties."
  },
  "quote-vs-invoice-estimate": {
    quotationNumber: "QUO-2026-0842",
    quotationDate: "August 10, 2026",
    validUntilDate: "September 10, 2026 (30 Days)",
    vendorName: "Meridian Creative Solutions",
    vendorAddress: "100 Montgomery St, Suite 800, San Francisco, CA 94104",
    clientName: "GreenLeaf Organic Foods",
    clientAddress: "220 Market Street, Oakland, CA 94607",
    scopeSummary: "Fixed-price commercial quotation for corporate brand identity redesign, packaging asset development, and style guidelines.",
    itemizedQuote: "• Brand Strategy & Identity Architecture: $3,200.00\n• 4 Product Packaging Box Die-Line Designs: $2,800.00\n• Digital Style Guide & Vector Asset Masters: $1,500.00",
    estimatedTotal: "$7,500.00",
    validityTerms: "Prices quoted are fixed and guaranteed through the expiration date. Scope adjustments will require written change orders.",
    acceptanceSignature: "Elena Ross, Brand Director"
  },
  "invoice-photographers": {
    invoiceNumber: "INV-PHOTO-2026-08",
    invoiceDate: "2026-08-15",
    paymentDueDate: "2026-08-30",
    currency: "$",
    freelancerName: "Emma Nguyen",
    businessName: "Lumina Commercial Photography",
    freelancerAddress: "1450 Sutter St, Studio 4, San Francisco, CA 94109",
    freelancerEmail: "emma@luminaphoto.com",
    freelancerPhone: "+1 (415) 555-0176",
    clientName: "Sarah Chen",
    clientCompanyName: "Verve Fashion Apparel",
    clientAddress: "500 Broadway, New York, NY 10012",
    clientEmail: "billing@vervefashion.com",
    shootDate: "August 12, 2026",
    shootLocation: "Studio Pier 35, San Francisco",
    sessionFee: "$1,800.00",
    licensingFee: "$1,200.00",
    postProductionFee: "$650.00",
    equipmentFee: "$350.00",
    subtotal: "$4,000.00",
    taxPercent: "8%",
    taxAmount: "$320.00",
    total: "$4,320.00",
    paymentMethod: "Direct Bank Wire or ACH",
    licensingTerms: "Worldwide digital commercial usage rights for 2 years across web, social, and digital lookbooks.",
    paymentTerms: "Net 15 days from invoice issuance"
  },
  "invoice-virtual-assistant": {
    invoiceNumber: "VA-2026-042",
    invoiceDate: "2026-08-01",
    paymentDueDate: "2026-08-15",
    currency: "$",
    freelancerName: "Avery Morgan",
    businessName: "Avery Morgan Executive Admin",
    freelancerAddress: "320 Pine Street, Seattle, WA 98101",
    freelancerEmail: "avery@averyadmin.com",
    freelancerPhone: "+1 (206) 555-0143",
    clientName: "David Sterling",
    clientCompanyName: "Vanguard Advisory Partners",
    clientAddress: "800 5th Ave, Seattle, WA 98104",
    billingPeriod: "July 1 – July 31, 2026",
    hourlyRate: "$45.00/hr",
    hoursLogged: "40 hrs",
    retainerAmount: "$1,800.00",
    additionalTasksAmount: "$225.00",
    subtotal: "$2,025.00",
    taxPercent: "0%",
    taxAmount: "$0.00",
    total: "$2,025.00",
    paymentMethod: "Stripe / Direct Deposit",
    paymentTerms: "Due within 14 calendar days"
  },
  "invoice-bookkeeper": {
    invoiceNumber: "BK-2026-018",
    invoiceDate: "2026-08-05",
    paymentDueDate: "2026-08-20",
    currency: "$",
    freelancerName: "Priya Sharma",
    businessName: "Precision Ledger Bookkeeping",
    freelancerAddress: "100 Innovation Way, Austin, TX 78701",
    freelancerEmail: "priya@precisionledger.com",
    freelancerPhone: "+1 (512) 555-0199",
    clientName: "Robert Hayes",
    clientCompanyName: "Hayes Auto Repairs Inc.",
    clientAddress: "1400 Congress Ave, Austin, TX 78704",
    monthlyClosingFee: "$650.00",
    reconciliationFee: "$350.00",
    payrollFee: "$250.00",
    subtotal: "$1,250.00",
    taxPercent: "0%",
    taxAmount: "$0.00",
    ...
    paymentTerms: "Due on the 20th of the current month"
  },
  "invoice-general-contractor": {
    invoiceNumber: "GC-2026-104",
    invoiceDate: "2026-08-10",
    paymentDueDate: "2026-08-25",
    currency: "$",
    contractorName: "Mark Vance",
    businessName: "Vanguard Builders LLC",
    contractorAddress: "720 Industrial Rd, Denver, CO 80216",
    contractorEmail: "mark@vanguardbuilders.com",
    contractorPhone: "+1 (303) 555-0184",
    clientName: "Catherine Bell",
    clientCompanyName: "Bell Medical Center",
    clientAddress: "1800 Colorado Blvd, Denver, CO 80220",
    jobDescription: "Phase 2 Commercial Renovation: Drywall, Electrical, and Flooring",
    framingLabor: "$3,400.00",
    materialsTotal: "$4,850.00",
    subcontractorFee: "$2,200.00",
    permitsInspection: "$650.00",
    subtotal: "$11,100.00",
    taxPercent: "8.5%",
    taxAmount: "$943.50",
    total: "$12,043.50",
    paymentMethod: "Bank Wire / Certified Check",
    paymentTerms: "Net 15 days upon milestone inspection sign-off"
  },
  "invoice-microsoft-word": {
    invoiceNumber: "DOCX-2026-09",
    invoiceDate: "2026-08-12",
    paymentDueDate: "2026-08-27",
    currency: "$",
    freelancerName: "Julian Thorne",
    businessName: "Thorne Design Consultancy",
    freelancerAddress: "500 Grand Ave, Chicago, IL 60611",
    freelancerEmail: "julian@thornedesign.com",
    freelancerPhone: "+1 (312) 555-0138",
    clientName: "Alexander Wright",
    clientCompanyName: "Horizon Capital LLC",
    clientAddress: "200 S Wacker Dr, Chicago, IL 60606",
    serviceItem1: "Word Document Design & Typography Setup",
    servicePrice1: "$1,400.00",
    serviceItem2: "Executive Report Template Master",
    servicePrice2: "$950.00",
    subtotal: "$2,350.00",
    taxPercent: "8%",
    taxAmount: "$188.00",
    total: "$2,538.00",
  ...
  "invoice-excel-sheet": {
    invoiceNumber: "XLS-2026-071",
    invoiceDate: "2026-08-14",
    paymentDueDate: "2026-08-29",
    currency: "$",
    freelancerName: "Marcus Reed",
    businessName: "Reed Analytics & Modeling",
    freelancerAddress: "1200 Market St, Philadelphia, PA 19107",
    freelancerEmail: "marcus@reedanalytics.com",
    freelancerPhone: "+1 (215) 555-0129",
    clientName: "Helen Keller",
    clientCompanyName: "Keystone Logistics",
    clientAddress: "3000 Chestnut St, Philadelphia, PA 19104",
    formulaAudit: "$1,200.00",
    macroAutomation: "$1,600.00",
    subtotal: "$2,800.00",
    taxPercent: "6%",
    taxAmount: "$168.00",
    total: "$2,968.00",
  ...
  "invoice-google-sheets": {
    invoiceNumber: "GSH-2026-033",
    invoiceDate: "2026-08-16",
    paymentDueDate: "2026-08-31",
    currency: "$",
    freelancerName: "Nina Kowalski",
    businessName: "CloudSync Operations",
    freelancerAddress: "450 7th Ave, New York, NY 10123",
    freelancerEmail: "nina@cloudsyncops.com",
    freelancerPhone: "+1 (212) 555-0187",
    clientName: "Gary Thomas",
    clientCompanyName: "Starlight E-commerce",
    clientAddress: "100 Broadway, New York, NY 10005",
    dashboardBuild: "$1,500.00",
    apiConnector: "$1,100.00",
    subtotal: "$2,600.00",
    taxPercent: "8.875%",
    taxAmount: "$230.75",
    total: "$2,830.75",
...
export const SLUG_BRAND: Record<string, string> = {
  "invoice-photographers": "Lumina Commercial Photography",
  "invoice-virtual-assistant": "Avery Morgan Executive Admin",
  "invoice-bookkeeper": "Precision Ledger Bookkeeping",
  "invoice-general-contractor": "Vanguard Builders LLC",
  "invoice-microsoft-word": "Thorne Design Consultancy",
  "invoice-excel-sheet": "Reed Analytics & Modeling",
  "invoice-google-sheets": "CloudSync Operations",
  // Expansion Resumes
  "resume-federal": "Jonathan Vance",
  "resume-entry-level": "Maya Lin",
  "resume-healthcare-ats": "Sarah Alpert, BSN, RN",
  "resume-finance-ats": "David K. Harrison, CFA",
  "resume-marketing-ats": "Elena Rostova",
  "resume-creative-designer": "Julian Thorne",
  "resume-executive-vp": "Victoria Vance",
  "resume-customer-success": "Marcus Chen",
  "resume-career-change": "Rachel Adams",
  // Expansion Contracts
  "simple-nda-agreement": "Nexis Innovations Inc.",
  "seo-service-contract": "SearchPeak Digital Media",
  "web-design-contract": "PixelCraft Interactive LLC",
  // Expansion Proposals
  "seo-proposal": "SearchPeak Digital Media",
  "web-design-proposal": "PixelCraft Interactive LLC",
  "sponsorship-proposal": "Global Tech Innovations Summit 2026",
  "construction-bid-proposal": "Highland Contracting Group",
  "quote-vs-invoice-estimate": "Meridian Creative Solutions",
  // Invoices
