...
export const SLUG_SPECIFIC_DEFAULTS: Record<string, Record<string, string>> = {
  "resume-federal": {
    ...
    email: "j.vance@fedmail.gov",
    phone: "+1 (202) 555-0193",
    address: "1240 Pennsylvania Ave SE, Washington, DC 20003",
    citizenship: "United States (U.S. Citizen)",
    clearanceLevel: "Top Secret / SCI (Active, PR 2025)",
    veteranPreference: "10-Point Preference (CPS - 30%+ Disabled Veteran)",
    targetGsGrade: "GS-13 / GS-14",
    announcementNumber: "OPM-DE-2026-0941",
    federalSummary: "Results-driven Program Analyst and Federal Project Manager with 8+ years of public sector experience leading interagency modernization, federal acquisition lifecycles (FAR compliant), and IT infrastructure programs across DoD and DHS.",
    fedJobTitle: "Senior Program Analyst (GS-13, Step 4)",
    fedAgency: "U.S. Department of Homeland Security — Cybersecurity & Infrastructure Security Agency",
    fedDates: "10/2022 – Present",
    hoursPerWeek: "40 Hours/Week",
    fedSeriesGrade: "Series 0343, Grade 13",
    supervisorName: "Col. Marcus Sterling",
    supervisorContact: "(202) 555-0144 — Yes, may be contacted",
    fedDutiesAndAccomplishments: "• Managed $14.2M federal capital equipment budget with 100% audit compliance under FAR regulations.\n• Led cross-functional working group of 28 engineers and policy specialists modernizing emergency response networks.\n• Authored 12 Congressional briefing memos and quarterly performance metrics reducing backlog by 34%.",
    educationDetails: "Master of Public Administration (MPA), George Washington University, Washington, DC (GPA: 3.89)",
    specializedTraining: "FAC-P/PM Level III Certified; DAWIA Level II in Contracting; PMP #2948102"
  },
  "resume-entry-level": {
    fullName: "Maya Lin",
    ...
    location: "Austin, TX",
    objectiveStatement: "Motivated B.S. in Communications graduate seeking an entry-level Junior Marketing Specialist role. Eager to apply strong research skills, social media campaign execution, and data-driven copywriting to accelerate brand engagement.",
    keyStrengths: "Social Media Management (Meta, TikTok), Google Analytics 4, Canva, Copywriting, Asana, Hubspot Inbound Certified",
    academicSchool: "University of Texas at Austin — B.S. in Communications & Media",
    gpaOrHonors: "Dean's List (2024, 2025), Cum Laude, GPA: 3.78/4.0",
    relevantProjects: "Led 6-student capstone project increasing campus non-profit event registration by 145% through targeted Instagram campaigns.",
    extracurriculars: "Vice President, Student Advertising Association (2024–2025); Staff Writer, The Daily Texan",
    volunteerWork: "120+ hours with Austin Youth Literacy Alliance tutoring middle school students in reading comprehension."
  },
