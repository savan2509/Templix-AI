      ...
      >
        ...
        <div id="editorial-board">
          <div id="editorial-standards">
            <Section heading="Editorial & Formatting Standards">
              <p className="mb-4">
                Templix AI is built on a foundation of privacy-first engineering, rigorous formatting conventions, and clean document structure:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 not-prose mb-6">
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 bg-zinc-50/50 dark:bg-zinc-900/50 flex flex-col justify-between">
                  <div>
                    <h4 className="font-bold text-sm text-zinc-900 dark:text-white">Commercial Agreement Structure</h4>
                    <p className="text-xs text-blue-600 dark:text-blue-400 font-semibold">Standard Commercial Conventions</p>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Our blueprints follow commercial agreement conventions and industry standard formatting for digital execution.</p>
                  </div>
                  <div className="pt-3">
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 bg-zinc-50/50 dark:bg-zinc-900/50 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Document text compilation occurs locally in your browser with zero remote storage of document content.</p>
                  </div>
                  <div className="pt-3">
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 bg-zinc-50/50 dark:bg-zinc-900/50 flex flex-col justify-between">
                  <div>
                    <h4 className="font-bold text-sm text-zinc-900 dark:text-white">ATS-Friendly Layouts</h4>
                    <p className="text-xs text-violet-600 dark:text-violet-400 font-semibold">Single-Column Hierarchy</p>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Resume templates adhere to standard single-column heading hierarchies so automated ATS screeners index your credentials cleanly.</p>
                  </div>
                  <div className="pt-3">
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-violet-50 dark:bg-violet-950/60 text-[10px] font-semibold text-violet-700 dark:text-violet-300 border border-violet-200/60 dark:border-violet-900/50">
                      ATS-Friendly Blueprints
                    </span>
                  </div>
                </div>
              </div>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 italic">
                Disclaimer: Templix AI provides customizable document templates designed according to general commercial conventions. Templix AI is not a law firm and does not provide legal advice.
              </p>
            </Section>
          </div>
        </div>
