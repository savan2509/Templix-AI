...
export default function LocaleNotFound() {
  const quickCategories = [
    ...
    { title: "Industry Solutions", href: "/en/industries", desc: "Construction, real estate & tech forms" },
        ...
        <div className="mx-auto max-w-4xl space-y-12 text-center">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-base leading-relaxed">
              The page you are looking for might have been moved or renamed. Search below or explore our popular document categories.
            </p>
          </div>
          ...
          <div className="space-y-6 pt-4">
            <div className="text-center">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                Access curated free templates and automated productivity tools
              </p>
            </div>
