        ...
        <div className="bg-white dark:bg-zinc-900 py-8 px-4 border border-zinc-200 dark:border-zinc-800 shadow-xl rounded-2xl sm:px-10 space-y-6">
          ...
          {success ? (
            <div className="p-4 rounded-xl bg-green-50 dark:bg-green-950/20 border border-green-200/50 dark:border-green-900/30 text-center space-y-2">
              ...
              <h3 className="font-bold text-sm text-zinc-850 dark:text-zinc-200">Check your email</h3>
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              <div>
                <label htmlFor="email" className="block text-xs font-semibold text-zinc-550 dark:text-zinc-400 uppercase tracking-wider mb-2">
                  Email Address
                </label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={loading !== null}
              className="flex items-center justify-center gap-2 h-11 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-850 font-semibold text-sm text-zinc-700 dark:text-zinc-300 transition-colors shadow-sm"
            >
              {loading === "google" ? (
            ...
            >
              {loading === "github" ? (
                ...
                <>
                  <svg className="h-4.5 w-4.5 shrink-0 fill-current text-zinc-900 dark:text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
