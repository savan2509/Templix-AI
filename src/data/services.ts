...
export const SERVICES_DATA: ServiceData[] = [
  ...
  },
  {
    ...
    title: "AI Document Editing & Rewriting Service",
    metaTitle: "Free AI Document Editor & Rewriter | Edit Contracts & Proposals | Templix AI",
    description: "Edit, rephrase, and polish documents online with Templix AI's AI document editing service. Enhance tone, fix grammar, and format contracts.",
    metaDescription: "Rewrite and polish business documents with Templix AI's free AI document editing service. Adjust tone, simplify legal terms, and export clean PDF/Word files.",
    primaryKeyword: "AI document editing",
    secondaryKeywords: ["AI document editor free", "rewrite contract with AI", "online document polisher", "AI text enhancer"],
    h1: "AI Document Editing & Rewriting Service",
    heroSubtitle: "Transform rough drafts, contracts, and proposals into polished, professional documents using browser-based AI assistance.",
    ctaText: "Start Editing Documents",
    introText: "Templix AI's Document Editing Service allows professionals, freelancers, and businesses to enhance writing style, clarify complex contract language, and ensure zero grammatical errors. Edit directly in your browser with private client-side processing.",
    whyChooseUs: [
      { title: "Browser-Local Privacy", desc: "Your document text stays in your browser session and is never stored on external databases.", icon: "ShieldCheck" },
      { title: "Tone & Voice Shifting", desc: "Easily switch document tone to Professional, Legal, Persuasive, or Executive.", icon: "Sliders" },
      { title: "Contract Simplification", desc: "Translate dense legalese into plain English clauses without losing legal enforceability.", icon: "Sparkles" },
      { title: "Instant Word/PDF Export", desc: "Export edited files directly to formatted Microsoft Word (.docx) or print-ready PDF.", icon: "Download" },
    ],
    features: [
      { title: "Grammar & Syntax Fixer", desc: "Identify and eliminate awkward phrasing, typos, and punctuation errors in real time.", icon: "CheckSquare" },
      { title: "Executive Polish AI", desc: "Elevate proposal and report phrasing to sound confident and authoritative.", icon: "FileText" },
      { title: "Clause Rewriter", desc: "Adjust contract clauses for clarity, liability limits, and dispute avoidance.", icon: "PenTool" },
      { title: "Multi-Format Import", desc: "Paste text or edit template presets directly with zero formatting loss.", icon: "Layout" },
    ],
    howItWorks: [
      { step: 1, title: "Open Document in Editor", desc: "Choose a template or paste your rough text directly into the rich editor." },
      { step: 2, title: "Select AI Polish Option", desc: "Highlight paragraphs to rewrite, check grammar, or simplify terminology." },
      { step: 3, title: "Review & Accept Changes", desc: "Compare side-by-side versions and accept suggested AI revisions." },
      { step: 4, title: "Download Formatted File", desc: "Export high-resolution PDF or clean Word (.docx) file instantly." },
    ],
    targetIndustries: [
      { role: "Agencies & Consultancies", desc: "Polish client proposals, statements of work, and quarterly strategy briefs." },
      { role: "Freelancers & Contractors", desc: "Review freelance contracts and client agreements before signing." },
      { role: "Job Seekers", desc: "Refine resume bullet points and cover letter introductions for maximum impact." },
      { role: "Business Owners", desc: "Standardize employee memos, supplier agreements, and policy notices." },
    ],
    benefits: [
      { title: "Save Drafting Time", desc: "Turn raw bullet notes into complete professional paragraphs in seconds." },
      { title: "Eliminate Embarrassing Errors", desc: "Catch subtle grammatical and formatting mistakes before clients see them." },
      { title: "Strengthen Business Credibility", desc: "Deliver documents that communicate expertise, clarity, and precision." },
    ],
    faqs: [
      { question: "Is the AI document editor free to use?", answer: "Yes, Templix AI provides 100% free document editing with no watermark and no credit card required." },
      { question: "Is my text kept private?", answer: "Yes. Document editing and rendering occur client-side in your browser; text is never saved or used to train machine learning models." },
      { question: "Can I edit existing PDF or Word documents?", answer: "Yes, you can paste text or use our free PDF/Word converter utilities to bring content into the editor." },
    ],
    relatedServices: [
      { name: "AI Document Generation", href: "/services/ai-document-generation" },
      { name: "Business Proposal Service", href: "/services/business-proposal-service" },
    ...
    relatedTemplates: [
      { name: "Freelance Service Agreement", href: "/templates/contracts/freelance-agreement", category: "contracts" },
      { name: "Business Proposal", href: "/templates/proposals/proposal-web-design", category: "proposals" },
    ],
    relatedTools: [
      { name: "AI Rewrite Tool", href: "/tools/ai-rewrite-tool", desc: "Paraphrase and polish text" },
      { name: "AI Grammar Checker", href: "/tools/ai-grammar-checker", desc: "Check spelling and grammar" },
    ],
  },
  {
    slug: "free-invoice-generator",
    title: "Free Online Invoice Generator Service",
    metaTitle: "Free Online Invoice Generator: Create PDF Invoices Instantly | Templix AI",
    description: "Create, calculate, and download professional PDF invoices online in seconds. Auto-calculate tax, discounts, and item totals with zero sign-up.",
    metaDescription: "Generate itemized PDF invoices online for free with Templix AI. Add company logos, calculate GST/VAT, customize payment terms, and download instantly.",
    primaryKeyword: "free invoice generator",
    secondaryKeywords: ["online invoice maker free", "invoice generator no sign up", "PDF invoice generator", "freelance invoice maker"],
    h1: "Free Online Invoice Generator",
    heroSubtitle: "Build, calculate, and download itemized business invoices in seconds with automated tax math and zero watermark.",
    ctaText: "Generate Invoice Now",
    introText: "Templix AI's Free Invoice Generator gives freelancers, contractors, and small business owners an instant way to bill clients. Add line items, apply local tax rates, specify payment terms, and download clean vector PDFs ready for immediate remittance.",
    whyChooseUs: [
      { title: "No Sign-Up or Paywall", desc: "Create unlimited professional invoices without creating an account or paying fees.", icon: "Zap" },
      { title: "Automated Calculations", desc: "Line totals, taxes, discounts, and balances compute in real time as you type.", icon: "Calculator" },
      { title: "Global Currency Support", desc: "Bill clients in USD ($), EUR (€), GBP (£), INR (₹), CAD, AUD, or any international currency.", icon: "Globe" },
      { title: "Instant Vector PDF", desc: "Download high-resolution PDFs formatted to strict international accounting standards.", icon: "Download" },
    ],
    features: [
      { title: "Line Item Manager", desc: "Add hours, quantities, unit prices, and descriptions with one click.", icon: "List" },
      { title: "Tax & Discount Engine", desc: "Apply single or multi-state sales tax, GST, VAT, and percentage discounts easily.", icon: "Percent" },
      { title: "Custom Payment Instructions", desc: "Include bank wire routing details, PayPal/Stripe handles, or UPI QR codes.", icon: "CreditCard" },
      { title: "Sequential Numbering", desc: "Assign custom invoice codes (e.g., INV-2026-001) for audit compliance.", icon: "Hash" },
    ],
    howItWorks: [
      { step: 1, title: "Enter Seller & Client Info", desc: "Input your business name, contact info, client details, and invoice dates." },
      { step: 2, title: "Add Billable Line Items", desc: "List services or products with hours, quantities, and rates." },
      { step: 3, title: "Configure Tax & Terms", desc: "Select your tax rate and payment terms (Net 15, Net 30, Due Upon Receipt)." },
      { step: 4, title: "Download PDF / Word", desc: "Click download to generate a clean, unwatermarked PDF or Word invoice." },
    ],
    targetIndustries: [
      { role: "Freelancers & Designers", desc: "Bill clients for creative milestones, retainer hours, and project assets." },
      { role: "General Contractors", desc: "Itemize labor hours and building materials on clear itemized bills." },
      { role: "Virtual Assistants", desc: "Invoice for monthly administrative support, calendar, and inbox hours." },
      { role: "Consultants & Coaches", desc: "Send professional advisory bills with bank wire remittance info." },
    ],
    benefits: [
      { title: "Get Paid Faster", desc: "Clear itemized breakdowns with explicit due dates speed up client approvals." },
      { title: "Look 100% Professional", desc: "Clean modern typography and structured layout establish instant trust." },
      { title: "Zero Data Stored", desc: "All invoice generation is client-side for complete financial privacy." },
    ],
    faqs: [
      { question: "Is this invoice generator really free?", answer: "Yes, it is 100% free with no monthly subscription, no watermark, and no account required." },
      { question: "Can I download my invoice as a PDF?", answer: "Yes, you can download a print-ready vector PDF or editable Microsoft Word document immediately." },
      { question: "Can I calculate sales tax and GST?", answer: "Yes, enter your tax percentage and the generator automatically adds tax to subtotals." },
    ],
    relatedServices: [
      { name: "Invoice Creation Service", href: "/services/invoice-creation-service" },
      { name: "AI Document Generation", href: "/services/ai-document-generation" },
    ...
    relatedTemplates: [
      { name: "Freelancer Invoice Template", href: "/templates/invoices/invoice-freelancer", category: "invoices" },
      { name: "Photography Invoice", href: "/templates/invoices/invoice-photographers", category: "invoices" },
    ],
    relatedTools: [
      { name: "GST Calculator", href: "/tools/gst-calculator", desc: "Calculate GST and taxes" },
      { name: "Invoice Number Generator", href: "/tools/invoice-number-generator", desc: "Generate sequential invoice numbers" },
    ],
  },
  {
    slug: "free-resume-builder",
    title: "Free Online Resume Builder Service",
    metaTitle: "Free AI Resume Builder: Build ATS-Friendly Resumes Online | Templix AI",
    description: "Build ATS-friendly, HRXML-compliant resumes online for free. AI bullet point assistance, single-column formatting, and instant PDF/Word download.",
    metaDescription: "Create ATS-compliant resumes online with Templix AI's free resume builder. Single-column layouts, pre-written bullet points, and free PDF downloads.",
    primaryKeyword: "free resume builder",
    secondaryKeywords: ["AI resume builder free", "resume builder no sign up", "ATS resume builder", "free CV maker online"],
    h1: "Free Interactive Resume Builder",
    heroSubtitle: "Build HRXML-compliant, recruiter-approved ATS resumes online in under 10 minutes with zero sign-up fees.",
    ctaText: "Build My Resume Free",
    introText: "Templix AI's Free Resume Builder helps job seekers, students, and executives create resumes that pass Applicant Tracking Systems (ATS) and impress hiring managers. Choose proven single-column layouts, enhance bullets with AI, and download PDF or Word files with no hidden paywalls.",
    whyChooseUs: [
      { title: "100% Free Downloads", desc: "Download unwatermarked PDFs and Word files without hitting a paywall at the end.", icon: "Zap" },
      { title: "ATS-First Architecture", desc: "Built with single-column layouts tested across Workday, Greenhouse, and Taleo.", icon: "CheckSquare" },
      { title: "AI Bullet Generator", desc: "Turn vague job descriptions into quantified achievement metrics with one click.", icon: "Sparkles" },
      { title: "Private & Local", desc: "Your personal contact information and employment history stay in your browser.", icon: "ShieldCheck" },
    ],
    features: [
      { title: "Skills Auto-Suggest", desc: "Select high-ranking industry keywords for Tech, Healthcare, Finance, and Marketing.", icon: "List" },
      { title: "Summary Generator", desc: "Draft a compelling 3-sentence executive bio tailored to your target job title.", icon: "UserCheck" },
      { title: "Real-Time ATS Checker", desc: "Review readability scores and section completeness as you type.", icon: "Search" },
      { title: "Multi-Format Export", desc: "Download high-resolution vector PDF or editable Microsoft Word (.docx) files.", icon: "Download" },
    ],
    howItWorks: [
      { step: 1, title: "Choose ATS Layout", desc: "Select an approved single-column or modern professional template." },
      { step: 2, title: "Fill Experience & Education", desc: "Input your job roles, dates, degrees, and core competencies." },
      { step: 3, title: "Optimize with AI", desc: "Enhance bullet points with action verbs and quantifiable metrics." },
      { step: 4, title: "Download & Apply", desc: "Export your finished resume and start applying to dream roles." },
    ],
    targetIndustries: [
      { role: "Software Engineers", desc: "Highlight tech stacks, GitHub projects, and system scalability metrics." },
      { role: "Healthcare & Nurses", desc: "Detail clinical rotations, state licensing, and EHR software experience." },
      { role: "Finance & CPAs", desc: "Highlight FP&A modeling, GAAP accounting, and valuation expertise." },
      { role: "Career Changers", desc: "Deploy hybrid skills-first layouts highlighting transferable accomplishments." },
    ],
    benefits: [
      { title: "Pass Automated Screeners", desc: "Ensure your resume parses cleanly into recruiter database searches." },
      { title: "Land More Interviews", desc: "Stand out to hiring managers with structured, impact-driven achievements." },
      { title: "No Subscription Traps", desc: "Never worry about surprise recurring monthly charges." },
    ],
    faqs: [
      { question: "Is the resume builder truly free?", answer: "Yes, you can build and download your completed resume in PDF or Word format without paying a dime or entering a credit card." },
      { question: "Are the resumes ATS-compliant?", answer: "Yes! Every template follows strict single-column HRXML formatting that parses accurately across Workday, Greenhouse, and Lever." },
      { question: "Can I download my resume as a Word file?", answer: "Yes, you can export your resume as an editable .docx file or print-ready PDF." },
    ],
    relatedServices: [
      { name: "Resume Writing Service", href: "/services/resume-writing-service" },
      { name: "Cover Letter Writing Service", href: "/services/cover-letter-writing-service" },
    ...
    relatedTemplates: [
      { name: "Software Engineer Resume", href: "/templates/resumes/resume-software-engineer", category: "resumes" },
      { name: "Career Change Resume", href: "/templates/resumes/resume-career-change", category: "resumes" },
    ],
    relatedTools: [
      { name: "Resume ATS Checker", href: "/tools/resume-ats-checker", desc: "Score your resume for ATS compatibility" },
      { name: "AI Resume Summary Generator", href: "/tools/ai-resume-summary-generator", desc: "Generate professional bio summaries" },
