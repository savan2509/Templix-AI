    ...
    content: {
      ...
      editorState: {
        ...
        content: [
          ...
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier Name: " }, { type: "text", text: "{{sellerName}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier Address: " }, { type: "text", text: "{{sellerAddress}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier GSTIN: " }, { type: "text", text: "{{sellerGstin}}" }] },
          ...
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Billed To Name: " }, { type: "text", text: "{{buyerName}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Billed To Address: " }, { type: "text", text: "{{buyerAddress}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Buyer GSTIN: " }, { type: "text", text: "{{buyerGstin}}" }] },
