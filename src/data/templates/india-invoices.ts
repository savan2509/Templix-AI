    ...
    content: {
      ...
      editorState: {
        ...
        content: [
          ...
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier Name: " }, { type: "text", text: "{{consignorName}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier Address: " }, { type: "text", text: "{{consignorAddress}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Supplier GSTIN: " }, { type: "text", text: "{{consignorGstin}}" }] },
          ...
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Billed To Name: " }, { type: "text", text: "{{consigneeName}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Billed To Address: " }, { type: "text", text: "{{consigneeAddress}}" }] },
          { type: "paragraph", content: [{ type: "text", marks: [{ type: "bold" }], text: "Buyer GSTIN: " }, { type: "text", text: "{{consigneeGstin}}" }] },
